...
let package = Package(
    name: "ffmpegkit",
    products: [
        .library(name: "ffmpegkit", targets: ["ffmpegkit", "lame", "libavcodec", "libavdevice", "libavfilter", "libavformat", "libavutil", "libilbc", "libogg", "libopencore-amrnb", "libsndfile", "libswresample", "libswscale", "libvorbis", "libvorbisenc", "libvorbisfile", "opus", "shine", "soxr", "speex", "twolame", "vo-amrwbenc", "Depend"])
    ],
    targets: [
